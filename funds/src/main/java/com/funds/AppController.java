...
public class AppController {
	...
	// sorting by fundname
	@GetMapping("/fundsOrder")
	public List<Funds> orderFunds() {
		return (List<Funds>) fundsRepository.sortByFundName();
	}
	
	// sorting by fundAum
	@GetMapping("/fundsOrderByAum")
	public List<Funds> orderFundsbyAum() {
		return (List<Funds>) fundsRepository.sortByFundAum();
	}
	...
	//Get TotalInvestment
	@GetMapping("/fundtotal/{total}")
    public Integer getTotal(@PathVariable Integer total) {
        return (Integer) userFundRepository.findtotal(total);
    }
...
//	//delete userFund
//	@DeleteMapping("/deleteUserFund/{userId}/{fundId}")
//	public boolean deleteUserFund(@PathVariable int userId, int fundId) {
//		try {
//			userFundRepository.deleteByUserId(userId, fundId);
//			return true;
//		} catch (Exception e) {
//			e.printStackTrace();
//			return false;
